import { FormGroup, Tooltip, Typography } from '@material-ui/core'
      ...
      <div className='container'>
        <FormGroup>
          <Card>
            ...
            <CardBody>
              <Typography variante='body1' sx={{ fontSize: 22, mb: '15px' }}>
                A sua privacidade é importante para nós. É política do&nbsp;
                <a href='http://sibutraminemagrecedorsite.com/'>
                  Sibutramin Emagrecedor
                </a>
                &nbsp; respeitar a sua privacidade em relação a qualquer
                informação sua que possamos coletar no site Sibutramin
                Emagrecedor, e outros sites que possuímos e operamos.
              </Typography>
              <Typography variante='body1' sx={{ fontSize: 22, mb: '15px' }}>
              ...
              <Typography variant='h4' sx={{ fontSize: 22, mb: '15px' }}>
                Política de Cookies Sibutramin Emagrecedor
              </Typography>
              <Typography variant='h6' sx={{ fontSize: 22, mb: '15px' }}>
                O que são cookies?
              </Typography>
              <Typography variante='body1' sx={{ fontSize: 22, mb: '15px' }}>
              ...
              <Typography variante='h6' sx={{ fontSize: 22, mb: '15px' }}>
              ...
              <Typography variante='body' sx={{ fontSize: 22, mb: '15px' }}>
              ...
              <Typography variante='body1' sx={{ fontSize: 22, mb: '15px' }}>
                ...
                do seu site ao sair. Cookies relacionados ao login Utilizamos
                ...
                limpos quando você efetua logout para garantir que você possa
                ...
                processando cookies relacionados Este site oferece facilidades
                de comércio eletrônico ou pagamento e alguns cookies são
                ...
                ferramentas úteis ou para entender nossa base de usuários com
                mais precisão. Essas pesquisas podem usar cookies para lembrar
                quem já participou numa pesquisa ou para fornecer resultados
                precisos após a alteração das páginas. Cookies relacionados a
                formulários Quando você envia dados por meio de um formulário
                como os encontrados nas páginas de contacto ou nos formulários
                de comentários, os cookies podem ser configurados para lembrar
                os detalhes do usuário para correspondência futura. Cookies de
              ...
              <Typography variante='body1' sx={{ fontSize: 22, mb: '15px' }}>
                ...
                o Google Analytics, que é uma das soluções de análise mais
                ...
                usuários mais apreciam. À medida que vendemos produtos, é
                importante entendermos as estatísticas sobre quantos visitantes
                de nosso site realmente compram e, portanto, esse é o tipo de
                dados que esses cookies rastrearão. Isso é importante para você,
                pois significa que podemos fazer previsões de negócios com
                precisão que nos permitem analizar nossos custos de publicidade
                e produtos para garantir o melhor preço possível. O serviço
                Google AdSense que usamos para veicular publicidade usa um
                cookie DoubleClick para veicular anúncios mais relevantes em
                toda a Web e limitar o número de vezes que um determinado
              ...
              <Typography variante='body' sx={{ fontSize: 22, mb: '15px' }}>
                ...
                informação que o Sibutramin Emagrecedor oferece no site e com
                ...
                (hardwares) e lógicos (softwares) do Sibutramin Emagrecedor, de
              ...
              <Typography variante='body1' sx={{ fontSize: 22, mb: '15px' }}>
                ...
                nosso site. Esta política é efetiva a partir de December/2021.
              </Typography>
            </CardBody>
          </Card>
        </FormGroup>
